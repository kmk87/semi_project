...
<%@ page import="com.cm.board.vo.QBoardComment , com.cm.user.vo.User" %>
...
<%@ include file="../include/new_header.jsp" %>
    ...
    <%@page import="com.cm.board.vo.QBoard, java.util.* ,com.cm.user.vo.User ,com.cm.board.vo.LocationGu" %>
<section>
    <div class="container-test">
        ...
        <div class="post-meta">
           ...
           <a href="/#?post_no=<%= qboard.getPostNo() %>" >쪽지</a>
        </div>
...
<section class="comments-section">
    <div class="container-test">
        ...
        <form action="/qboard/comment/insert" method="post" class="comment-form">
            ...
            <input type="hidden" name="user_no" value="<%= ((User)session.getAttribute("user")).getUser_no() %>">
