...
<body>
	...
	<section id="section_id">
        ...
        <form action="/saleShare/edit" method="post" enctype="multipart/form-data" id="form_id" name="form_id">
        <input type="hidden" name="postNo" value="${postNo}" >
            ...
            <div class="form_group">
                ...
                <input type="text" id="prod_id" name="post_title" placeholder="text" value="<%= list.getPost_title() %>">
                <span id="span_leng">0/20</span>
                <span id="error_message">20자리까지 작성가능합니다.</span></p><br><br>
            ...
            <div class="form_group">
                <div class="textarea-container">
                    ...
                    <textarea placeholder="자세한 설명 글 올리기" id="description" name="post_text"><%= list.getPost_title() %></textarea>
                </div>
            </div>
        </form>
       ...
       function readURL(input) {
           if (input.files && input.files[0]) {
               ...
               reader.onload = function(e) {
                   $('#View').attr('src', e.target.result).show();
               }
