            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body justify-content-between" style="margin-left:20%; margin-right:20%;">
                    ...
                    <ul class="navbar-nav menu-list list-unstyled d-flex gap-md-3 mb-0">
                                ...
                                <li class="nav-item">
                                    <a href="/views/user/myQBoardPost.jsp" class="nav-link">내 게시글</a>
                                </li>
                                <li class="nav-item">
                                    <a href="/views/user/myQBoardLike.jsp" class="nav-link">좋아요</a>
                                </li>
                                <li class="nav-item">
                                    <a href="/user/myMeetings" class="nav-link">내 모임</a>
                                </li>
                                <li class="nav-item">
