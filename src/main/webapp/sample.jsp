  ...
  <section id="clothing" class="my-5 overflow-hidden">
    <div class="container pb-5">
      ...
      <div class="section-header d-md-flex justify-content-between align-items-center mb-3">
        <h2 class="display-3 fw-normal" style="font-size: 40px;"><img src="resources/images/pink_fire.png" style="padding-bottom: 12px;">
          인기 모임 Top 7</h2>
        <div>
          <a href="#" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1" style="margin-left: 5px;">
            더보기</a>
        </div>
      </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="resources/images/item1.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0" style="font-size: 20px;"><img src="resources/images/profile.png" width="35px" style="margin-bottom: 5px;"><span style="margin-left: 8px;">thal3416님</span></h3>
                </a>
                ...
                <div class="card-text">
                  ...
                  <div class="d-flex flex-wrap mt-3">
                    <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3">
                      <h5 class="text-uppercase m-0">가입신청</h5>
                    </a>
